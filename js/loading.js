...
(function () {
    ...
    function buildLoader() {
        ...
        const iconData = [
            { icon: 'fa-car',             left: '5%',  top: '12%', dur: '9s',  delay: '0s'   },
            { icon: 'fa-wrench',          left: '87%', top: '18%', dur: '11s', delay: '1.8s' },
            { icon: 'fa-gauge-high',      left: '10%', top: '72%', dur: '10s', delay: '3.2s' },
            { icon: 'fa-gears',           left: '80%', top: '65%', dur: '8.5s',delay: '2.4s' },
            { icon: 'fa-screwdriver',     left: '54%', top: '6%',  dur: '9s',  delay: '1.2s' },
            { icon: 'fa-oil-can',         left: '22%', top: '83%', dur: '12s', delay: '4.0s' },
            { icon: 'fa-bolt',            left: '69%', top: '10%', dur: '8s',  delay: '2.9s' },
            { icon: 'fa-battery-full',    left: '42%', top: '80%', dur: '10s', delay: '3.6s' },
            { icon: 'fa-cogs',            left: '92%', top: '44%', dur: '9.5s',delay: '1.5s' },
            { icon: 'fa-tools',           left: '2%',  top: '44%', dur: '8.5s',delay: '2.7s' },
        ];
        ...
        loader.setAttribute('aria-label', 'Loading Stackly Auto Parts');
        loader.innerHTML = `
            ...
            <div class="loader-content">
                ...
                <div class="loader-logo-wrap">
                    <img class="loader-logo-img"
                         src="assets/home/stackly logo orange.webp"
                         onerror="this.style.display='none';document.getElementById('loader-text-logo').style.display='block';"
                         alt="Stackly Logo">
                    <span id="loader-text-logo" style="display:none;font-family:'Outfit',sans-serif;font-size:1.9rem;font-weight:800;color:#FF6B00;letter-spacing:-0.02em;">STACKLY</span>
                    <span class="loader-brand-pill">Auto Parts & Tuning</span>
                </div>
                ...
                <div class="loader-ring-wrap">
                    ...
                    <div class="loader-ring-core">
                        <i class="loader-heart-icon fa-solid fa-car"></i>
                    </div>
                </div>
            ...
            <!-- Bottom tagline -->
            <p class="loader-tagline">Your Ride, Our Passion &nbsp;&middot;&nbsp; Stackly Auto Parts&#8482;</p>
        `;
    ...
    const messages = ['Running Diagnostics', 'Calibrating Coilovers', 'Optimizing ECU Map', 'Dyno Fine-Tuning', 'Ready to Drive'];
    let msgIdx = 0;
